...
related:
  - EnvironmentBanner
---
# Initialization Guide Card

Displays during agent environment initialization with progress bar, estimated time, and actionable configuration items.
...
- [EnvironmentBanner](/en/reference/environment-banner)
